...
$config['sess_cookie_name'] = 'ci_griya';
...
$config['link_admin_role_create'] = $config['base_url'].'admin/admin_role_create';
$config['link_admin_role_lists'] = $config['base_url'].'admin/admin_role_lists';
$config['link_admin_role_update'] = $config['base_url'].'admin/admin_role_update';
