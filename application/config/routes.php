...
$route['admin/admin_role_create'] = 'admin/lainnya/admin_role_create';
$route['admin/admin_role_delete'] = 'admin/lainnya/admin_role_delete';
$route['admin/admin_role_get'] = 'admin/lainnya/admin_role_get';
$route['admin/admin_role_lists'] = 'admin/lainnya/admin_role_lists';
$route['admin/admin_role_update'] = 'admin/lainnya/admin_role_update';
