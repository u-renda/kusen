<section role="main" class="content-body">
	...
	<!-- start: page -->
	<div class="row" id="pengaturan_lists_page">
		<div class="col-md-6 col-lg-12 col-xl-6">
			<section class="panel">
				<div class="panel-body">
					<a href="<?php echo $this->config->item('link_admin_pengaturan_create'); ?>" type="button" class="mb-xl mt-xs mr-xs btn btn-primary">
