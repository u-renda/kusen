    ...
    <div class="row">
        <div class="col-md-12">
            <section class="panel panel-featured">
                ...
                <form action="<?php echo $this->config->item('link_admin_keunggulan_update').'?id='.$id; ?>" method="post" class="form-horizontal form-bordered">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="logo" class="form-control" value="<?php echo set_value('logo', $result->logo); ?>">
